...
FriendURLConf=[
    ...
    path('book/friend/<int:friend_id>/edit',FriendUpdateView.as_view(), name='friend_edit'),
    path('book/friend/<int:friend_id>/delete',FriendDeleteView.as_view(), name='friend_delete'),
]
